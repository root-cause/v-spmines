...
// Generated Mon, 30 Mar 2020 18:56:36 GMT
// https://alloc8or.github.io/gta5/nativedb/
...
namespace CAM
{
	...
	static void DESTROY_CAM(Cam cam, BOOL thisScriptCheck) { invoke<Void>(0x865908C81A2C22E9, cam, thisScriptCheck); } // 0x865908C81A2C22E9 0xC39302BD b323
	static void DESTROY_ALL_CAMS(BOOL thisScriptCheck) { invoke<Void>(0x8E5FB15663F79120, thisScriptCheck); } // 0x8E5FB15663F79120 0x10C151CE b323
...
namespace DATAFILE
{
	...
	static void _OBJECT_VALUE_ADD_INTEGER(Any* objectData, const char* key, int value) { invoke<Void>(0xE7E035450A7948D5, objectData, key, value); } // 0xE7E035450A7948D5 0xEFCF554A b323
	static void _OBJECT_VALUE_ADD_FLOAT(Any* objectData, const char* key, float value) { invoke<Void>(0xC27E1CC2D795105E, objectData, key, value); } // 0xC27E1CC2D795105E 0xE972CACF b323
	...
	static Any* _OBJECT_VALUE_ADD_OBJECT(Any* objectData, const char* key) { return invoke<Any*>(0xA358F56F10732EE1, objectData, key); } // 0xA358F56F10732EE1 0x96A8E05F b323
	...
	static BOOL _OBJECT_VALUE_GET_BOOLEAN(Any* objectData, const char* key) { return invoke<BOOL>(0x1186940ED72FFEEC, objectData, key); } // 0x1186940ED72FFEEC 0x8876C872 b323
	static int _OBJECT_VALUE_GET_INTEGER(Any* objectData, const char* key) { return invoke<int>(0x78F06F6B1FB5A80C, objectData, key); } // 0x78F06F6B1FB5A80C 0xA6C68693 b323
	static float _OBJECT_VALUE_GET_FLOAT(Any* objectData, const char* key) { return invoke<float>(0x06610343E73B9727, objectData, key); } // 0x06610343E73B9727 0xA92C1AF4 b323
	static const char* _OBJECT_VALUE_GET_STRING(Any* objectData, const char* key) { return invoke<const char*>(0x3D2FD9E763B24472, objectData, key); } // 0x3D2FD9E763B24472 0x942160EC b323
	...
	static Any* _OBJECT_VALUE_GET_OBJECT(Any* objectData, const char* key) { return invoke<Any*>(0xB6B9DDC412FCEEE2, objectData, key); } // 0xB6B9DDC412FCEEE2 0xC9C13D8D b323
	static Any* _OBJECT_VALUE_GET_ARRAY(Any* objectData, const char* key) { return invoke<Any*>(0x7A983AA9DA2659ED, objectData, key); } // 0x7A983AA9DA2659ED 0x1F2F7D00 b323
	...
	static void _ARRAY_VALUE_ADD_BOOLEAN(Any* arrayData, BOOL value) { invoke<Void>(0xF8B0F5A43E928C76, arrayData, value); } // 0xF8B0F5A43E928C76 0x08174B90 b323
	static void _ARRAY_VALUE_ADD_INTEGER(Any* arrayData, int value) { invoke<Void>(0xCABDB751D86FE93B, arrayData, value); } // 0xCABDB751D86FE93B 0xF29C0B36 b323
	static void _ARRAY_VALUE_ADD_FLOAT(Any* arrayData, float value) { invoke<Void>(0x57A995FD75D37F56, arrayData, value); } // 0x57A995FD75D37F56 0xE4302123 b323
	...
	static Any* _ARRAY_VALUE_ADD_OBJECT(Any* arrayData) { return invoke<Any*>(0x6889498B3E19C797, arrayData); } // 0x6889498B3E19C797 0xC174C71B b323
	...
	static int _ARRAY_VALUE_GET_INTEGER(Any* arrayData, int arrayIndex) { return invoke<int>(0x3E5AE19425CD74BE, arrayData, arrayIndex); } // 0x3E5AE19425CD74BE 0xBB120CFC b323
	static float _ARRAY_VALUE_GET_FLOAT(Any* arrayData, int arrayIndex) { return invoke<float>(0xC0C527B525D7CFB5, arrayData, arrayIndex); } // 0xC0C527B525D7CFB5 0x08AD2CC2 b323
	static const char* _ARRAY_VALUE_GET_STRING(Any* arrayData, int arrayIndex) { return invoke<const char*>(0xD3F2FFEB8D836F52, arrayData, arrayIndex); } // 0xD3F2FFEB8D836F52 0x93F985A6 b323
	...
	static Any* _ARRAY_VALUE_GET_OBJECT(Any* arrayData, int arrayIndex) { return invoke<Any*>(0x8B5FADCC4E3A145F, arrayData, arrayIndex); } // 0x8B5FADCC4E3A145F 0xECE81278 b323
	static int _ARRAY_VALUE_GET_SIZE(Any* arrayData) { return invoke<int>(0x065DB281590CEA2D, arrayData); } // 0x065DB281590CEA2D 0xA8A21766 b323
...
namespace ENTITY
{
	...
	static void _ATTACH_ENTITY_BONE_TO_ENTITY_BONE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x5C48B75732C8456C, p0, p1, p2, p3, p4, p5); } // 0x5C48B75732C8456C b791
	static void _ATTACH_ENTITY_BONE_TO_ENTITY_BONE_PHYSICALLY(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0xFD1695C5D3B05439, p0, p1, p2, p3, p4, p5); } // 0xFD1695C5D3B05439 b791
...
namespace GRAPHICS
{
	...
	static void SET_SCRIPT_GFX_ALIGN(int x, int y) { invoke<Void>(0xB8A850F20A067EB6, x, y); } // 0xB8A850F20A067EB6 0x228A2598 b323
	static void RESET_SCRIPT_GFX_ALIGN() { invoke<Void>(0xE3A3DB414A373DAB); } // 0xE3A3DB414A373DAB 0x3FE33BD6 b323
	static void SET_SCRIPT_GFX_ALIGN_PARAMS(float x, float y, float p2, float p3) { invoke<Void>(0xF5A2C681787E579D, x, y, p2, p3); } // 0xF5A2C681787E579D 0x76C641E4 b323
	static void _GET_SCRIPT_GFX_POSITION(float p0, float p1, float* p2, float* p3) { invoke<Void>(0x6DD8F5AA635EB4B2, p0, p1, p2, p3); } // 0x6DD8F5AA635EB4B2 b323
	...
	static void _0xDE81239437E8C5A8() { invoke<Void>(0xDE81239437E8C5A8); } // 0xDE81239437E8C5A8 0xDB7AECDA b323
	...
	static void _0xA44FF770DFBC5DAE() { invoke<Void>(0xA44FF770DFBC5DAE); } // 0xA44FF770DFBC5DAE b323
...
namespace HUD
{
	...
	static void _ADD_TEXT_COMPONENT_SUBSTRING_UNK(const char* p0) { invoke<Void>(0x5F68520888E69014, p0); } // 0x5F68520888E69014 0x0829A799 b323
	...
	static BOOL _GET_LEVEL_BLIP_SPRITE() { return invoke<BOOL>(0x4A9923385BDB9DAD); } // 0x4A9923385BDB9DAD 0x87871CE0 b323
	static int _GET_WAYPOINT_BLIP_SPRITE() { return invoke<int>(0x186E5D252FA50E7D); } // 0x186E5D252FA50E7D 0xB9827942 b323
	...
	static void _0xF1A6C18B35BCADE6(BOOL p0) { invoke<Void>(0xF1A6C18B35BCADE6, p0); } // 0xF1A6C18B35BCADE6 0xA2CAAB4F b323
	...
	static Any _0x3F0CF9CB7E589B88() { return invoke<Any>(0x3F0CF9CB7E589B88); } // 0x3F0CF9CB7E589B88 b463
...
namespace INTERIOR
{
	...
	static BOOL _ARE_COORDS_COLLIDING_WITH_EXTERIOR(float x, float y, float z) { return invoke<BOOL>(0xEEA5AC2EDA7C33E8, x, y, z); } // 0xEEA5AC2EDA7C33E8 0x7762249C b323
...
namespace MISC
{
	...
	static BOOL _IS_PROJECTILE_TYPE_IN_RADIUS(float p0, float p1, float p2, Any p3, float p4, BOOL p5) { return invoke<BOOL>(0x34318593248C8FB2, p0, p1, p2, p3, p4, p5); } // 0x34318593248C8FB2 0xBE81F1E2 b323
	static Any _GET_IS_PROJECTILE_TYPE_IN_AREA(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { return invoke<Any>(0x8D7A43EC6A5FEA45, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x8D7A43EC6A5FEA45 0x1A40454B b323
	static BOOL _GET_PROJECTILE_NEAR_PED_COORDS(Ped ped, Hash weaponHash, float radius, Entity* entity, BOOL p4) { return invoke<BOOL>(0xDFB4138EEFED7B81, ped, weaponHash, radius, entity, p4); } // 0xDFB4138EEFED7B81 0x6BDE5CE4 b323
	...
	static void _RESET_LOCALPLAYER_STATE() { invoke<Void>(0xC0AA53F866B3134D); } // 0xC0AA53F866B3134D 0x5D209F25 b323
	static void _0x0A60017F841A54F2(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x0A60017F841A54F2, p0, p1, p2, p3); } // 0x0A60017F841A54F2 0x2D33F15A b323
	static void _0x1FF6BF9A63E5757F() { invoke<Void>(0x1FF6BF9A63E5757F); } // 0x1FF6BF9A63E5757F 0xDF99925C b323
	...
	static BOOL _0x8EF5573A1F801A5C(Any p0, Any* p1, Any* p2) { return invoke<BOOL>(0x8EF5573A1F801A5C, p0, p1, p2); } // 0x8EF5573A1F801A5C 0x07FF553F b323
...
namespace MONEY
{
	...
	static int _NETWORK_GET_REMAINING_VC_DAILY_TRANSFERS_2() { return invoke<int>(0xEA560AC9EEB1E19B); } // 0xEA560AC9EEB1E19B 0xA9021211 b323
...
namespace NETWORK
{
	...
	static BOOL NETWORK_HAVE_JUST_UPLOAD_LATER() { return invoke<BOOL>(0x85443FF4C328F53B); } // 0x85443FF4C328F53B 0x3FB40673 b323
	...
	static void _NETWORK_BLOCK_INVITES_2(BOOL toggle) { invoke<Void>(0xCFEB8AF24FC1D0BB, toggle); } // 0xCFEB8AF24FC1D0BB 0x8AB4890B b323
	...
	static BOOL NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(Entity entity) { return invoke<BOOL>(0x18A47D074708FD68, entity); } // 0x18A47D074708FD68 0x1E2E3177 b323
	...
	static void NETWORK_SET_RICH_PRESENCE_STRING(Any p0, const char* string) { invoke<Void>(0x3E200C2BCF4164EB, p0, string); } // 0x3E200C2BCF4164EB 0x017E6777 b323
...
namespace OBJECT
{
	static Object CREATE_OBJECT(Object modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { return invoke<Object>(0x509D5878EB39E842, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic); } // 0x509D5878EB39E842 0x2F7AA05C b323
	static Object CREATE_OBJECT_NO_OFFSET(Hash modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { return invoke<Object>(0x9A294B2138ABB884, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic); } // 0x9A294B2138ABB884 0x58040420 b323
	...
	static void _0x758A5C1B3B1E1990(Any p0) { invoke<Void>(0x758A5C1B3B1E1990, p0); } // 0x758A5C1B3B1E1990 b1011
	...
	static void _0x1C1B69FAE509BA97(Any p0, Any p1) { invoke<Void>(0x1C1B69FAE509BA97, p0, p1); } // 0x1C1B69FAE509BA97 b757
	static void _0x858EC9FD25DE04AA(Any p0, Any p1) { invoke<Void>(0x858EC9FD25DE04AA, p0, p1); } // 0x858EC9FD25DE04AA b757
	static void _0x3ED2B83AB2E82799(Any p0, Any p1) { invoke<Void>(0x3ED2B83AB2E82799, p0, p1); } // 0x3ED2B83AB2E82799 b757
...
namespace PED
{
	static Ped CREATE_PED(int pedType, Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Ped>(0xD49F9B0955C367DE, pedType, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); } // 0xD49F9B0955C367DE 0x0389EF71 b323
	static void DELETE_PED(Ped* ped) { invoke<Void>(0x9614299DCB53E54B, ped); } // 0x9614299DCB53E54B 0x13EFB9A0 b323
	static Ped CLONE_PED(Ped ped, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Ped>(0xEF29A16337FACADB, ped, heading, isNetwork, thisScriptCheck); } // 0xEF29A16337FACADB 0x8C8A8D6E b323
	static Ped _CLONE_PED_EX(Ped ped, float heading, BOOL isNetwork, BOOL thisScriptCheck, Any p4) { return invoke<Ped>(0x668FD40BCBA5DE48, ped, heading, isNetwork, thisScriptCheck, p4); } // 0x668FD40BCBA5DE48 b463
	...
	static Ped CREATE_PED_INSIDE_VEHICLE(Vehicle vehicle, int pedType, Hash modelHash, int seat, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Ped>(0x7DD959874C1FD534, vehicle, pedType, modelHash, seat, isNetwork, thisScriptCheck); } // 0x7DD959874C1FD534 0x3000F092 b323
	...
	static Vehicle GET_VEHICLE_PED_IS_IN(Ped ped, BOOL lastVehicle) { return invoke<Vehicle>(0x9A9112A0FE9A4713, ped, lastVehicle); } // 0x9A9112A0FE9A4713 0xAFE92319 b323
	...
	static void SET_PED_MODEL_IS_SUPPRESSED(Ped ped, BOOL toggle) { invoke<Void>(0xE163A4BCE4DE6F11, ped, toggle); } // 0xE163A4BCE4DE6F11 0x7820CA43 b323
...
namespace PHYSICS
{
	...
	static void _0xAA6A6098851C396F(BOOL p0) { invoke<Void>(0xAA6A6098851C396F, p0); } // 0xAA6A6098851C396F b1604
}
...
{
	static int _GET_TOTAL_SC_INBOX_IDS() { return invoke<int>(0x03A93FF1A2CA0864); } // 0x03A93FF1A2CA0864 0x6BE5DF29 b323
	...
	static BOOL _0x1F1E9682483697C7(Any p0, Any p1) { return invoke<BOOL>(0x1F1E9682483697C7, p0, p1); } // 0x1F1E9682483697C7 0x90C74343 b323
	static Any _0xC4C4575F62534A24() { return invoke<Any>(0xC4C4575F62534A24); } // 0xC4C4575F62534A24 b323
	static BOOL _0x287F1F75D2803595(Any p0, Any* p1) { return invoke<BOOL>(0x287F1F75D2803595, p0, p1); } // 0x287F1F75D2803595 0x3ACE6D6B b323
...
namespace TASK
{
	...
	static void TASK_OPEN_VEHICLE_DOOR(Ped ped, Vehicle vehicle, int timeOut, int doorIndex, float speed) { invoke<Void>(0x965791A9A488A062, ped, vehicle, timeOut, doorIndex, speed); } // 0x965791A9A488A062 0x8EE06BF4 b323
	...
	static int GET_SCRIPT_TASK_STATUS(Ped targetPed, Hash taskHash) { return invoke<int>(0x77F1BEB8863288D5, targetPed, taskHash); } // 0x77F1BEB8863288D5 0xB2477B23 b323
...
namespace VEHICLE
{
	static Vehicle CREATE_VEHICLE(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck, BOOL p7) { return invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, thisScriptCheck, p7); } // 0xAF35D0D2583051B0 0xDD75460A b323
	...
	static void _0x9A75585FB2E54FAD(float x, float y, float z, float p3) { invoke<Void>(0x9A75585FB2E54FAD, x, y, z, p3); } // 0x9A75585FB2E54FAD 0x935A95DA b323
	...
	static int GET_VEHICLE_RECORDING_ID(int p0, const char* p1) { return invoke<int>(0x21543C612379DB3C, p0, p1); } // 0x21543C612379DB3C 0x328D601D b323
	static void REQUEST_VEHICLE_RECORDING(int i, const char* name) { invoke<Void>(0xAF514CABE74CBF15, i, name); } // 0xAF514CABE74CBF15 0x91AFEFD9 b323
	static BOOL HAS_VEHICLE_RECORDING_BEEN_LOADED(Any p0, Any* p1) { return invoke<BOOL>(0x300D614A4C785FC4, p0, p1); } // 0x300D614A4C785FC4 0xF52CD7F5 b323
	static void REMOVE_VEHICLE_RECORDING(Any p0, Any* p1) { invoke<Void>(0xF1160ACCF98A3FC8, p0, p1); } // 0xF1160ACCF98A3FC8 0xD3C05B00 b323
	...
	static float GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID(Any p0) { return invoke<float>(0x102D125411A7B6E6, p0); } // 0x102D125411A7B6E6 0x7116785E b323
	static float GET_TOTAL_DURATION_OF_VEHICLE_RECORDING(Any p0, Any p1) { return invoke<float>(0x0E48D1C262390950, p0, p1); } // 0x0E48D1C262390950 0x5B35EEB7 b323
	...
	static void START_PLAYBACK_RECORDED_VEHICLE(Vehicle vehicle, int p1, const char* playback, BOOL p3) { invoke<Void>(0x3F878F92B3A7A071, vehicle, p1, playback, p3); } // 0x3F878F92B3A7A071 0xCF614CA8 b323
	static void START_PLAYBACK_RECORDED_VEHICLE_WITH_FLAGS(Vehicle vehicle, Any p1, const char* playback, Any p3, Any p4, Any p5) { invoke<Void>(0x7D80FD645D4DA346, vehicle, p1, playback, p3, p4, p5); } // 0x7D80FD645D4DA346 0x4E721AD2 b323
	static void _0x1F2E4E06DEA8992B(Vehicle vehicle, BOOL p1) { invoke<Void>(0x1F2E4E06DEA8992B, vehicle, p1); } // 0x1F2E4E06DEA8992B 0x01B91CD0 b323
	...
	static void START_PLAYBACK_RECORDED_VEHICLE_USING_AI(Any p0, Any p1, Any* p2, float p3, Any p4) { invoke<Void>(0x29DE5FA52D00428C, p0, p1, p2, p3, p4); } // 0x29DE5FA52D00428C 0x8DE8E24E b323
	static void SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(Any p0, float p1) { invoke<Void>(0x9438F7AD68771A20, p0, p1); } // 0x9438F7AD68771A20 0xCF3EFA4B b323
	static void SET_PLAYBACK_TO_USE_AI(Vehicle vehicle, int flag) { invoke<Void>(0xA549C3B37EA28131, vehicle, flag); } // 0xA549C3B37EA28131 0xB536CCD7 b323
	static void SET_PLAYBACK_TO_USE_AI_TRY_TO_REVERT_BACK_LATER(Any p0, Any p1, Any p2, BOOL p3) { invoke<Void>(0x6E63860BBB190730, p0, p1, p2, p3); } // 0x6E63860BBB190730 0x0C8ABAA4 b323
	...
	static void _0x063AE2B2CC273588(Any p0, BOOL p1) { invoke<Void>(0x063AE2B2CC273588, p0, p1); } // 0x063AE2B2CC273588 0x2EF8435C b323
	...
	static void GET_BOAT_BOOM_POSITION_RATIO(Any p0, BOOL p1) { invoke<Void>(0xC1F981A6F74F0C23, p0, p1); } // 0xC1F981A6F74F0C23 0x00966934 b323
	...
	static void _0xE6C0C80B8C867537(BOOL p0) { invoke<Void>(0xE6C0C80B8C867537, p0); } // 0xE6C0C80B8C867537 0xD2B8ACBD b323
	static void _0xF051D9BFB6BA39C0(Any p0) { invoke<Void>(0xF051D9BFB6BA39C0, p0); } // 0xF051D9BFB6BA39C0 b877
	static float _0x36492C2F0D134C56(Vehicle vehicle) { return invoke<float>(0x36492C2F0D134C56, vehicle); } // 0x36492C2F0D134C56 0xA4A75FCF b323
	static BOOL _0x48C633E94A8142A7(Vehicle vehicle) { return invoke<BOOL>(0x48C633E94A8142A7, vehicle); } // 0x48C633E94A8142A7 b877
	...
	static void _0x5B91B229243351A8(Any p0, Any p1) { invoke<Void>(0x5B91B229243351A8, p0, p1); } // 0x5B91B229243351A8 b791
